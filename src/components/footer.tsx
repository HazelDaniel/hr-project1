...
export const Footer: React.FC = () => {
  return (
    <>
      <footer className="py-12 text-white bg-slate-900 w-[99%] mx-auto rounded-t-md">
        <AnimatedSection>
          <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="grid gap-8 md:grid-cols-4 *:font-poppins">
              <div>
            ...
            <div className="pt-8 mt-8 text-center border-t border-[#fefefe]/50 text-slate-400">
